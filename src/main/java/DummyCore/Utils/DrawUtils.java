...
public class DrawUtils {
    ...
    public static void drawTexturedModalRect(
            int x, int y, int textureX, int textureY, int sizeX, int sizeY, int zLevel) {
        float f = 0.00390625F; // 1/256
        float f1 = 0.00390625F; // 1/256
        Tessellator tessellator = Tessellator.instance;
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(
                (double) (x + 0), (double) (y + sizeY), (double) zLevel, (double) ((float) (textureX + 0) * f), (double)
                        ((float) (textureY + sizeY) * f1));
        tessellator.addVertexWithUV(
                (double) (x + sizeX),
                (double) (y + sizeY),
                (double) zLevel,
    ...
    public static void renderItemStack(
        ...
        if (Minecraft.getMinecraft().gameSettings.fancyGraphics || force3DRender) {
            ...
            for (int l = 0; l < itemsAmount; ++l) {
                ...
                tessellator.addVertexWithUV(
                        (double) (0.0F - f7), (double) (0.0F - f8), 0.0D, (double) minU, (double) maxV);
                tessellator.addVertexWithUV(
                        (double) (f6 - f7), (double) (0.0F - f8), 0.0D, (double) maxU, (double) maxV);
                tessellator.addVertexWithUV(
                        (double) (f6 - f7), (double) (1.0F - f8), 0.0D, (double) maxU, (double) minV);
                tessellator.addVertexWithUV(
                        (double) (0.0F - f7), (double) (1.0F - f8), 0.0D, (double) minU, (double) minV);
                tessellator.draw();
                GL11.glPopMatrix();
            }
        }
