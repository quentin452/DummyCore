...
public class DummyDataUtils {
    ...
    public static void loadCustomDataForMod(String modid, String dataName) {
        ...
        if (s == Side.CLIENT) {
            ...
            MiscUtils.registeredServerWorldData
                    .put(modid + "|" + dataName, globalConfig.get(modid, dataName, "no data").getString());
            globalConfig.save();
            syncGlobalDataToClient(modid, dataName);
        }
    }
    ...
    public static void loadGlobalDataForMod(String modid) {
        ...
        if (s == Side.CLIENT) {
            ...
            globalConfig.load();
            MiscUtils.registeredServerWorldData
                    .put(modid + "|" + modid, globalConfig.get(modid, modid, "no data").getString());
            globalConfig.save();
    ...
    public static void loadPlayerDataForMod(String playerName, String modid, String dataName) {
        ...
        if (s == Side.CLIENT) {
            ...
            MiscUtils.registeredServerData
                    .put(playerName + "_" + modid + "|" + dataName, config.get(modid, dataName, "no data").getString());
            config.save();
            syncPlayerDataToClient(playerName, modid, dataName);
        }
    }
    ...
    public static void syncGlobalDataToClient(String modid, String dataName) {
        ...
        /*
         * if(MiscUtils.registeredServerWorldData.containsKey(modid+"|"+dataName)) { String dataString =
         * "||mod:DummyCore.InfoSync"+"||"+modid+":"+dataName+"||ddata:"+MiscUtils.registeredServerWorldData.get(modid+
         * "|"+dataName); DummyPacketIMSG simplePacket = new DummyPacketIMSG(dataString);
         * CoreInitialiser.packetHandler.sendToAll(simplePacket); }else { Notifier.notifyCustomMod(modid,
         * "The sync packet for data "+modid+"|"+
         * dataName+" could not be generated - the requested server data does not exist!"); }
         */
    }
    ...
    public static void syncGlobalDataToClient(String modid) {
        ...
        /*
         * if(MiscUtils.registeredServerWorldData.containsKey(modid+"|"+modid)) { String dataString =
         * "||mod:DummyCore.InfoSync"+"||"+modid+":"+modid+"||ddata:"+MiscUtils.registeredServerWorldData.get(modid+"|"+
         * modid); DummyPacketIMSG simplePacket = new DummyPacketIMSG(dataString);
         * CoreInitialiser.packetHandler.sendToAll(simplePacket); }else { Notifier.notifyCustomMod(modid,
         * "The sync packet for data "+modid+ "could not be generated - the requested server data does not exist!"); }
         */
    }
    ...
    public static void syncPlayerDataToClient(String playerName, String modid, String dataName) {
        ...
        /*
         * if(MiscUtils.registeredServerData.containsKey(playerName+"_"+modid+"|"+dataName)) { String dataString =
         * "||mod:DummyCore.PlayerInfoSync"+"||"+"playerName:"+playerName+"||"+modid+ ":" +
         * dataName+"||ddata:"+MiscUtils.registeredServerData.get(playerName+"_"+modid+"|"+dataName); DummyPacketIMSG
         * simplePacket = new DummyPacketIMSG(dataString); CoreInitialiser.packetHandler.sendToAll(simplePacket); }else
         * { Notifier.notifyCustomMod(modid, "The sync packet for data "+playerName+"_"+modid+
