...
public class MiscUtils {
    ...
    public static final Hashtable<String, EnumChatFormatting> descriptionCTable =
            new Hashtable<String, EnumChatFormatting>();
    public static final Hashtable<List<?>, String> descriptionNTable = new Hashtable<List<?>, String>();
    public static final Hashtable<List<?>, EnumChatFormatting> descriptionNCTable =
     ...
     */
    public static void playSoundOnServerToAllNearby(
            double x, double y, double z, String sound, float volume, float pitch, double radius, int dim) {
    ...
    public static boolean oreDictionaryCompare(ItemStack stk, ItemStack stk1) {
        ...
        if (OreDictionary.getOreIDs(stk) == null
                || OreDictionary.getOreIDs(stk).length == 0
    ...
    public static void setPrivateFinalValue(
            Class<?> classToAccess, Object instance, Object value, String fieldNames[]) {
    ...
    public static int extendPotionArray(int byAmount) {
        ...
        setPrivateFinalValue(
                ...
                ObfuscationReflectionHelper.remapFieldNames(
                        Potion.class.getName(), new String[] {"potionTypes", "field_76425_a", "a"}));
