    ...
    public void removeMissingTextureErrors() {
        if (CoreInitialiser.cfg.removeMissingTexturesErrors) {
            try {
                ...
                SetMultimap<String, ResourceLocation> smmp =
                        SetMultimap.class.cast(missingTextures.get(FMLClientHandler.instance()));
                smmp.clear();
                ...
                Table<String, String, Set<ResourceLocation>> table =
                        Table.class.cast(brokenTextures.get(FMLClientHandler.instance()));
                table.clear();
